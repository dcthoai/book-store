...
CREATE TABLE `review` (
  ...
  UNIQUE KEY `Unique_Review_Customer_Book` (`customerID`,`bookID`),
  ...
  CONSTRAINT `FK_Review_Customer` FOREIGN KEY (`customerID`) REFERENCES `user` (`userID`) ON DELETE CASCADE ON UPDATE CASCADE
