...
--
-- Table structure for table `reviewtmedia`
--

DROP TABLE IF EXISTS `reviewtmedia`;
...
CREATE TABLE `reviewtmedia` (
  ...
  KEY `FK_ReviewMedia_Media` (`mediaID`),
...
--
-- Dumping data for table `reviewtmedia`
--

LOCK TABLES `reviewtmedia` WRITE;
/*!40000 ALTER TABLE `reviewtmedia` DISABLE KEYS */;
/*!40000 ALTER TABLE `reviewtmedia` ENABLE KEYS */;
UNLOCK TABLES;
